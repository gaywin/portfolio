export type CaseStudy = {
  ...
  role: string; team: string; challenge: string; insight: string; strategy: string;
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    role: "Lead product designer", team: "Product, engineering, editorial, community partners", challenge: "Create one coherent experience across live scores, local content and community participation, while working within real device and connectivity constraints.",
  ...
  },
  {
    ...
    role: "Senior product designer", team: "Founders, product, compliance, engineering", challenge: "Reduce the cognitive and trust barriers of cross-border investment without hiding the detail people need for confident decisions.",
  ...
  },
  {
    ...
    role: "Product design lead", team: "Product, data, engineering, customer success", challenge: "Serve users with very different levels of expertise while improving data quality across long, interdependent reporting workflows.",
